(function(){
  ...
  function drawFW(){
    const fx=W*.12,fy=H*.38,R=FW.R;
    cx.save();cx.globalAlpha=.65;
  ...
  function draw(){
    ...
    const glow=cx.createRadialGradient(W*.5,H*.4,0,W*.5,H*.4,W*.7);
    glow.addColorStop(0,'rgba(0,229,255,.035)');glow.addColorStop(1,'transparent');
